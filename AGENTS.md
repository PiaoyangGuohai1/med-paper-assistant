...
| 層級                             | 機制                                                                                          | 觸發       | 實作狀態                                           |
| -------------------------------- | --------------------------------------------------------------------------------------------- | ---------- | -------------------------------------------------- |
| **L1** Event-Driven Hooks        | 78 個品質檢查（52 Code-Enforced / 26 Agent-Driven）                                           | Agent 操作 | ✅ 部分                                            |
...
| **C1, C2, C8** post-ms | 全稿一致性、投稿清單、時間一致性                                        | `check_formatting`, `scan_draft_citations`, `read_draft` |
| **E1-E5** EQUATOR      | 報告指引自動偵測、checklist 逐條驗證、合規報告                          | `read_draft`, `patch_draft`                              |
| **P3, P6, P8** commit  | 概念一致、.memory 更新、方法學驗證                                      | `scan_draft_citations`, `read_draft`, `count_words`      |
